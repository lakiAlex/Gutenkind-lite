...
function admin() {
  var setDefault = document.querySelector('.voss-set-default input[type=checkbox]');
  ...
  var dataBg = document.querySelectorAll('[data-bg]');
